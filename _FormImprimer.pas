...
type
  ...
  public
    ...
    procedure ImprGrilleNotes(Id_Periode:dword);//00525794
...
//00525794
procedure TFormImprimer.ImprGrilleNotes(Id_Periode:dword); //Impression Grille Notes
begin//0
  //00525794
...
begin//0
    ...
    begin//005258D6
      if (f374.NbrSerieNotes(Id_Periode) = 0) then
      begin//005258E8
    ...
    case GrilleType of
      0://00525A5C        
        VImpressionGrilleNotes := TImpressionGrilleNotes.Create(f374, Printer.Canvas,EnteteDePage , BasDePage, Id_Periode, GetSeriesdeNotes(0), GetNumeroterElevesSeriesDeNotes,f370);
      1://00525AA1
        VImpressionGrilleBilan := TImpressionGrilleBilan.Create(f374, Printer.Canvas,EnteteDePage , BasDePage, Id_Periode, GetSeriesdeNotes(1), GetNumeroterElevesBilans,f370);
      2://00525AE3
        VImpressionAppreciation := TImpressionAppreciation.Create(f374, Printer.Canvas,EnteteDePage , BasDePage, Id_Periode,Nil ,GetNumeroterElevesAppreciations,f370);
      3://00525B1D        
        VImpressionGrilleVierge := TImpressionGrilleVierge.Create(f374, Printer.Canvas,EnteteDePage , BasDePage, 0,GetSeriesdeNotes(2), GetnumeroterElevesGrilleVierge, f370);
    end;//2
    ...
    begin//00525C4E
      ...
      begin//00525C6F
        ...
        begin//00525C92
          case GrilleType of
            0://00525CAF
              VImpressionGrilleNotes.sub_0051BD4C(FormConfirmerImpression.FMinPage, FormConfirmerImpression.FMaxPage, FormConfirmerImpression.NbrExemplaires, FormConfirmerImpression.RadioGroupParite.ItemIndex, FormConfirmerImpression.CheckBoxOrdreInverse.Checked);
            1://00525D0E
            ...
            3://00525DC9
              VImpressionGrilleVierge.sub_00524130(FormConfirmerImpression.FMinPage, FormConfirmerImpression.FMaxPage, FormConfirmerImpression.NbrExemplaires, FormConfirmerImpression.RadioGroupParite.ItemIndex, FormConfirmerImpression.CheckBoxOrdreInverse.Checked);
           end;//5
        end;//4
      end;//3
    end;//2
