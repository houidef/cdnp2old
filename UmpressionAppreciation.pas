...
begin//0
  ...
  J := 0;
  f50[0] := 1;
  L := sub_0052199C Div (Fwidth - GetTailleColonne(GetImpressionDatesDeNaissanceAppreciations, GetImpressionRAppreciations) - sub_00522F88);
...
begin//0
  //00521C10
    ...
    lvar_24 := GetTailleColonne(GetImpressionDatesDeNaissanceAppreciations, GetImpressionRAppreciations);
    lvar_10 := FCdn.NbreEleves;
    lvar_2C := GetTextHeightOfTableau + $14{20};//EAX
    ...
    lvar_1C := 1;
      ...
      begin//3
        ...
        FCdn.GetNomsbulletins(f50[a - 1], buf);
        lvar_54 := ' ' + buf + ' ';
        lvar_1C := lvar_1C + 1;
      ...
      begin//3
        ...
        lvar_1C := 1;
          ...
          begin//5
            ...
            lvar_8C.Right := lvar_8C.Left + lvar_14;//EAX
            lvar_8C.Bottom := lvar_8C.Top + lvar_18;//EAX
            FCdn.GetApreciations(FIdPeriode, lvar_20, f50[a - 1], buf);
            lvar_54 := ' ' + buf + ' ';
            DrawTextA(FCanvas.Handle, PChar(lvar_54), Length(lvar_54), lvar_8C, 4);
          end;//5
...
begin//0
  //00522F04
  result := sub_0052199C * (f50[a] - f50[a - 1]) + GetTailleColonne(GetImpressionDatesDeNaissanceAppreciations, GetImpressionRAppreciations) + sub_00522F88;//EDI
end;//0
