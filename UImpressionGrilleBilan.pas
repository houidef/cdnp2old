...
begin//0
  ...
  SetLength(f50, 1);
  f50[0] := 1;
  K := (Fwidth - GetTailleColonne( GetImpressionDatesDeNaissanceBilans, GetImpressionRBilans))  Div sub_0051D370;
...
begin//0
    ...
    lvar_24 := GetTailleColonne(GetImpressionDatesDeNaissanceBilans, GetImpressionRBilans);
    lvar_10 := FCdn.NbreEleves ;
    lvar_2C := sub_00520890(a);
    lvar_40 := GetTextHeightOfTableau;
...
begin//0
  //00520890
  result := sub_0051D370 * (f50[a] - f50[a - 1]) + GetTailleColonne(GetImpressionDatesDeNaissanceBilans, GetImpressionRBilans);
end;//0
