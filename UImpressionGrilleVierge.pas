...
var
  ...
  lvar_88 : TRect;
begin//0
    lvar_38 := NbrLigneBasTableau;
    lvar_10 := sub_005243D4;
    ESI := FCanvas.TextHeight('ALEXANDRE') + 4;//ESI
    lvar_8 := f50[a] - f50[a - 1];
    lvar_1C := GetTailleColonne(GetImpressionDatesDeNaissanceGrilleVierge, GetimpressionRGrilleVierge);
    lvar_C := FCdn.NbreEleves ;
    lvar_20 := sub_005245A0(a);
    lvar_30 := GetTextHeightOfTableau;
    lvar_24 := ESI * lvar_38 + lvar_30 + 20;//EAX
    lvar_8C := Fwidth - lvar_20;
    lvar_28 := TRUNC(lvar_8C / 2);
    lvar_8C := FHeight - lvar_24;
    lvar_2C := TRUNC(lvar_8C / 2);
      ...
      begin//3
        ...
        lvar_4C := '';
        DrawTextA(FCanvas.Handle, PChar(lvar_4C), Length(lvar_4C), lvar_88, 5);
      end;//3
    lvar_44 := FCdn.NbreEleves ;
    if (FImprNbrEleve ) then
    begin//2
      //005232FA
      lvar_40 := FCanvas.TextWidth(' ' + IntToStr(lvar_44) + ' ');
    end//2
    else
    begin//2
      //0052333B
    ...
    begin//2
      ...
      begin//3
        ...
        begin//4
          ...
          lvar_4C := lvar_50;
          DrawTextA(FCanvas.Handle, PChar(lvar_4C), Length(lvar_4C), lvar_88, 4);
          lvar_88.Left := lvar_28 + lvar_40;//EAX
          lvar_88.Top := lvar_18 * ESI + lvar_2C;
          lvar_88.Right := lvar_88.Left + lvar_1C + lvar_40;
          lvar_88.Bottom := lvar_88.Top + ESI;
          if ((FCdn.IsRedoublant(lvar_18)) and GetimpressionRGrilleVierge) then//005234A3
          begin//5
              //005234AC
              lvar_1A0 := FCdn.GetEleveName(lvar_18);
              lvar_54  := lvar_1A0 + ' (R)';
          end//5
          else
          begin//5
            //005234F0
            lvar_54:=FCdn.GetEleveName(lvar_18);
          end;//5
          if (GetImpressionDatesDeNaissanceGrilleVierge) then
          begin//5
            //00523529
            lvar_1A0:=FCdn.GetDateNais(lvar_18);
        ...
        begin//4
          ...
          lvar_88.Bottom := lvar_88.Top + ESI;//EAX
          if ((FCdn.IsRedoublant(lvar_18)) and GetimpressionRGrilleVierge) then//0052365A
          begin//5
              //00523663
              lvar_1A0:= FCdn.GetEleveName(lvar_18);
              lvar_54 := lvar_1A0 + '(R)';
    ...
    begin//2
      //005238C4
        for lvar_14 := 0 to FInclureImpression.f8.count - 1 do//005238E1
        begin//4
          //005238EC
          FInclureImpression.fc[lvar_14] := false;  
          lvar_88.Left := lvar_28;//lvar_28
          lvar_88.Top := ESI * (FCdn.NbreEleves + lvar_3C + 1) + lvar_2C + 20;//EAX
          lvar_88.Right := lvar_88.Left + lvar_1C;//EAX
          lvar_88.Bottom := lvar_88.Top + ESI;//EAX
          lvar_4C := ' ' + FInclureImpression.f8[lvar_14] + ' ';
          DrawTextA(FCanvas.Handle, PChar(lvar_4C), Length(lvar_4C), lvar_88, 4);
            //00523A1C
            for lvar_78 := 1 to f50[a] - 1 - f50[a - 1] do
            begin//6
      ...
      begin//3
        ...
        begin//4
          //00523B3D
          FCanvas.MoveTo(lvar_28 + lvar_1C, lvar_2C);
          FCanvas.LineTo(lvar_28 + lvar_20, lvar_2C);
        end//4
        else
        begin//4
          //00523B6F
          FCanvas.MoveTo(lvar_28, lvar_14 * ESI + lvar_2C);
          FCanvas.LineTo(lvar_28 + lvar_20, lvar_14 * ESI + lvar_2C);
        end;//4
      end;//3
    if (lvar_38 > 0) then
    begin//2
      ...
      begin//3
        ...
        begin//4
          //00523BD2
          FCanvas.MoveTo(lvar_28, (FCdn.NbreEleves + 1 + lvar_14) * ESI + lvar_2C + 20);
          FCanvas.LineTo(lvar_28 + lvar_20, (FCdn.NbreEleves + 1 + lvar_14) * ESI + lvar_2C + 20);
        end;//4
      end;//3
    end;//2
      ...
      begin//3
        ...
        begin//4
          //00523C99
          FCanvas.MoveTo(lvar_28, lvar_2C + ESI);
          FCanvas.LineTo(lvar_28, lvar_2C + lvar_30);
        end//4
        else
        begin//4
          //00523CCD
          ...
          begin//5
            //00523CD2
            FCanvas.MoveTo(lvar_28 + lvar_1C, lvar_2C);
            FCanvas.LineTo(lvar_28 + lvar_1C, lvar_2C + lvar_30);
          end//5
          else
          begin//5
            //00523D0E
            FCanvas.MoveTo(lvar_28 + lvar_1C + (lvar_74 - 1) * lvar_10, lvar_2C);
            FCanvas.LineTo(lvar_28 + lvar_1C + (lvar_74 - 1) * lvar_10, lvar_2C + lvar_30);
          end;//5
        end;//4
      end;//3
    if (lvar_38 > 0) then
    begin//2
      //00523D9C
        ...
        begin//4
          ...
          begin//5
            //00523DBB
            FCanvas.MoveTo(lvar_28, lvar_2C + lvar_30 + 20);
            FCanvas.LineTo(lvar_28, lvar_2C + lvar_24);
          end//5
          else
          begin//5
            //00523DFA
            FCanvas.MoveTo(lvar_28 + lvar_1C + (lvar_74 - 1) * lvar_10, lvar_2C + lvar_30 + 20);
            FCanvas.LineTo(lvar_28 + lvar_1C + (lvar_74 - 1) * lvar_10, lvar_2C + lvar_24);
          end;//5
        end;//4
    end;//2
    if (FImprNbrEleve) then 
	begin
		lvar_40 := FCanvas.TextWidth(' ' + IntToStr(lvar_44) + ' ');
		FCanvas.MoveTo(lvar_28 + lvar_40, lvar_2C + ESI);
		FCanvas.LineTo(lvar_28 + lvar_40, (lvar_44 + 1) * ESI + lvar_2C);
	end;
...
begin//0
  //00523FE0
  result := FCanvas.TextWidth(f54) + 4;//EAX
end;//0
...
begin//0
  //005243EC
  K:=(Fwidth - GetTailleColonne(GetImpressionDatesDeNaissanceGrilleVierge, GetimpressionRGrilleVierge)) Div sub_005243D4;
...
begin//0
  //005245A0
  result := sub_005243D4 * (f50[a] - f50[a - 1]) + GetTailleColonne(GetImpressionDatesDeNaissanceGrilleVierge, GetimpressionRGrilleVierge);
end;//0
